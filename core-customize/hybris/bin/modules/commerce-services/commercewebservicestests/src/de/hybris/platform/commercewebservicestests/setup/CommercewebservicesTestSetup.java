...
public class CommercewebservicesTestSetup extends AbstractSystemSetup
{
	...
	protected void loadOptionalSampleData(final List<String> storeNames)
	{
		...
		if (extensionNames.contains("yacceleratorfulfilmentprocess") || extensionNames.contains("yacceleratorordermanagement"))
		{
		...
		if (extensionNames.contains("yacceleratorordermanagement"))
		{
			getSetupImpexService()
					.importImpexFile("/commercewebservicestests/import/orderprocess/projectdata-dynamic-business-process-order.impex",
							true);
			getSetupImpexService().importImpexFile(
					"/commercewebservicestests/import/orderprocess/projectdata-dynamic-business-process-consignment.impex", true);
			getSetupImpexService()
					.importImpexFile("/commercewebservicestests/import/orderprocess/projectdata-dynamic-business-process-return.impex",
							true);
			getSetupImpexService().importImpexFile(
					"/commercewebservicestests/import/orderprocess/projectdata-dynamic-business-process-sendReturnLabelEmail.impex",
					true);
		}
	}

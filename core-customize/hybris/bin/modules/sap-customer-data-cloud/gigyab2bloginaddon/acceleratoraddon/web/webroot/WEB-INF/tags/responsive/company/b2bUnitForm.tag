    ...
    <form:form action="${formUrl}" method="post" modelAttribute="b2BUnitForm">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                <formElement:formInputBox idKey="b2bunit.id" labelKey="b2bunit.id" path="uid" inputCSS="text" mandatory="true" disabled="true"/>
            </div>
            <div class="col-xs-12 col-sm-6">
                <formElement:formInputBox idKey="b2bunit.name" labelKey="b2bunit.name" path="name" inputCSS="text" mandatory="true" disabled="true"/>
            </div>
            <div class="col-xs-12 col-sm-6">
                <formElement:formSelectBox idKey="b2bunit.parent" labelKey="b2bunit.parent" path="parentUnit" selectCSSClass="form-control"
                                           mandatory="false" skipBlank="false" skipBlankMessageKey="form.select.empty" items="${branchSelectOptions}" disabled="true"/>
            </div>
            <div class="col-xs-12 col-sm-6">

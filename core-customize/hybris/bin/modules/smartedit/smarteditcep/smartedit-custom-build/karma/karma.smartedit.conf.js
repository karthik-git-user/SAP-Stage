...
const karma = compose(
    merge({
        junitReporter: {
            outputDir: 'jsTarget/tests/smarteditcep/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: lodash.concat(
            ...
            bundlePaths.test.unit.commonUtilModules, [
                ...
                'jsTarget/web/features/smarteditcep/**/*.js',
                'jsTarget/web/features/smarteditcep/templates.js',
                'jsTests/tests/smarteditcep/unit/specBundle.ts'
            ]
        ),
    ...
    add('exclude', [
        'jsTarget/web/features/smarteditcep/smarteditcep.ts',
        '**/*.d.ts',
        '*.d.ts'
    ], true)
)(base);

...
const karma = compose(
    merge({
        junitReporter: {
            outputDir: 'jsTarget/tests/smarteditcepcommons/junit/', // results will be saved as $outputDir/$browserName.xml
        ...
        files: lodash.concat(
            ...
            bundlePaths.test.unit.commonUtilModules, [
                ...
                'jsTarget/web/features/smarteditcepcommons/templates.js',
                'jsTests/tests/smarteditcepcommons/unit/specBundle.ts'
            ]
        ),

 ...
 */
angular
    .module('FakeModule', ['fake1Decorator', 'fake2Decorator'])
    .run(function(decoratorService, restServiceFactory, windowUtils) {
        ...
        windowUtils.runIntervalOutsideAngular(function() {
            if (sessionStorage.getItem('sso.authenticate.failure') !== 'true') {
                console.info('pinging configuration API to force re-auth after expiry');

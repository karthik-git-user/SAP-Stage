...
angular.module('e2eBackendMocks', ['ngMockE2E', 'resourceLocationsModule', 'smarteditServicesModule'])
    ...
    .constant('SMARTEDIT_RESOURCE_URI_REGEXP', /^(.*)\/jsTests\/tests\/smarteditcepContainer\/e2e/)
    .run(function($httpBackend, languageService, $log, parseQuery, I18N_RESOURCE_URI) {
        ...
        $httpBackend.whenGET(I18N_RESOURCE_URI + "/" + languageService.getBrowserLocale()).respond(function() {
            return [200, {
                ...
                "smarteditcep.logindialogform.username.and.password.required": "Username and password required",
                ...
                'smarteditcep.authentication.form.input.username': 'username',
                'smarteditcep.authentication.form.input.password': 'password',
                'smarteditcep.authentication.form.button.submit': 'submit',
                'smarteditcep.authentication.form.button.submit.sso': 'Sign with SSO',
                'smarteditcep.application.name': 'SmartEdit',
                'smarteditcep.logindialogform.oauth.error.default': 'An error has occurred'
            }];
        });
        ...
        $httpBackend.whenGET(/configuration/).respond(function(method, url, data, headers) {
            if (headers.Authorization === 'bearer ' + oauthToken0.access_token) {
                return [200, [{
                    ...
                    "value": "{\"smartEditLocation\":\"/jsTests/tests/smarteditcepContainer/e2e/apiAuthentication/mocksforAuthentication.js\"}",
                    "key": "applications.e2eBackendMocks"
                }, {
                    "value": "{\"smartEditLocation\":\"/jsTests/tests/smarteditcepContainer/e2e/apiAuthentication/dummyCmsDecorators.js\",\"authenticationMap\":{\"api1\":\"/authEntryPoint1\"}}",
                    "key": "applications.FakeModule"
                }, {
                    "value": "{\"smartEditContainerLocation\":\"/jsTests/tests/smarteditcepContainer/e2e/apiAuthentication/dummyContainerModule.js\"}",
        ...
        // For SmartEdit to be able to inject the CEP extension
        $httpBackend.whenGET(/smarteditcepContainer.js/).respond(function() {
            return [200, {
                status: 'OK'
            }];
        });

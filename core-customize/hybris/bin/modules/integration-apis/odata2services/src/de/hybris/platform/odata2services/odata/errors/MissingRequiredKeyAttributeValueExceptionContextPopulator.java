...
{
	private static final String MESSAGE_TEMPLATE = "Property [%s] is required for EntityType [%s].";
	...
	private static String message(final MissingRequiredKeyAttributeValueException e)
	{
		...
		return String.format(MESSAGE_TEMPLATE, attribute.getAttributeName(), attribute.getTypeDescriptor().getItemCode());
	}

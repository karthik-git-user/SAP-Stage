...
public class OData2Processor extends ODataSingleProcessor
{
	...
	@Override
	public BatchResponsePart executeChangeSet(final BatchHandler batchHandler, final List<ODataRequest> requests) throws ODataException
	{
	 ...
	 * @return An instance of the parameter object
	 */
	protected BatchParam getBatchParam(final BatchHandler batchHandler, final String responseContentType, final InputStream content)
	{
	...
	@Required
	public void setChangeSetPersistenceHandler(final ODataProcessorHandler<ChangeSetParam, BatchResponsePart> changeSetPersistenceHandler)
	{

 ...
 * the validator can throw an instance of {@link ItemSearchRequestValidationException} and to veto the search.
 */
public interface ItemSearchRequestValidator
{
	/**
	 * Validates the specifies item search request and rejects it by throwing an exception, if the
	 * specified request does not meet certain criteria.
	 * @param request a request to validate
	 * @throws ItemSearchRequestValidationException if request is not valid and cannot be corrected.
	 */

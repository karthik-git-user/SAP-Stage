...
class GetExpandSupportIntegrationTest extends ServicelayerSpockSpecification {
    ...
    private static def USER = 'tester'
    ...
    def setup() {
        IntegrationTestUtil.importImpEx(
                ...
                "                                            ; $EXPAND_SUPPORT_IO:Product                                         ; catalogVersion  ; Product:catalogVersion  ; ExpandSupport:CatalogVersion",
        )
    }
    ...
    def "expands collection of enums"() {
        ...
        IntegrationTestUtil.importImpEx(
                ...
                "                                             ; $EXPAND_SUPPORT_IO:TestIntegrationItem                              ; testEnums                    ; TestIntegrationItem:testEnums                       ; ExpandSupport:OData2webservicesFeatureTestPropertiesTypes   ; false",

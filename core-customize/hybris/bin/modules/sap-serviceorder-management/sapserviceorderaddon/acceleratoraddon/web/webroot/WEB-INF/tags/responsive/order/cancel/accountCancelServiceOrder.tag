...
<form:form action="${request.contextPath}/my-account/order/${fn:escapeXml(order.code)}/cancelservice/cancelconfirmation"
           id="confirmcancelserviceorderForm"
           modelAttribute="serviceOrderEntryCancelForm"
  ...
  <div id="serviceCancelReason" class="form-group">
		<label for="cancelReason">
	                    <spring:theme code="text.account.order.orderDetails.service.cancel.popup.reason.title"/>
	    </label>
	    <c:set var="placeholderforcancelreason"><spring:theme code="text.account.order.orderDetails.service.cancel.popup.reason.helpText"/></c:set>
		<form:textarea cssClass="form-control service_cancelreason--textarea" id="serviceCancelReason" path="cancelReason" placeholder="${placeholderforcancelreason}"/>
	</div>

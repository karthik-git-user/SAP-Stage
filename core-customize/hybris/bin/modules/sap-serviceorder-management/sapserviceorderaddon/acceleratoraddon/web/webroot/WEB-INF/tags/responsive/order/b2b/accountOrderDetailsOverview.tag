...
<div class="row">
    ...
    <div class="col-sm-12 col-md-3 item-action">
        ...
        <c:set var="serviceOrderCancellable" value="${order.serviceCancellable}" scope="request"/>
        <c:set var="serviceOrderReschedulable" value="${order.serviceReschedulable}" scope="request"/>

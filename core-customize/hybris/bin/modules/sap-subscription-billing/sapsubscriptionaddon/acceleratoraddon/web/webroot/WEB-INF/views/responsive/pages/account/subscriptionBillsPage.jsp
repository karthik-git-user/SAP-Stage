...
<c:set var="searchUrl" value="/my-account/subscription/bills?sort=${ycommerce:encodeUrl(searchPageData.pagination.sort)}"/>
...
<form:form id="billsForm" name="subscriptionBillForm" modelAttribute="subscriptionBillForm" action="${fn:escapeXml(viewSubscriptionBillsUrl)}" method="get" autocomplete="off">
            ...
            <div class="account-overview-table">
				<table class="orderhistory-list-table responsive-table">
					<tr class="account-orderhistory-table-head responsive-table-head hidden-xs">
						...
						<th><spring:theme code="text.account.subscriptions.bill.date" text="Billing Date"/></th>
					...
					<c:forEach items="${searchPageData.results}" var="subscriptionBill">
						<tr class="responsive-table-item">

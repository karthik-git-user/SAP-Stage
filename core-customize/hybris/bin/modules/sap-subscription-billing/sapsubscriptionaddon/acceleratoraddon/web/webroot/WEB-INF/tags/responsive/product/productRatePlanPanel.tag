...
<div class="container-fluid">
   <div class="row">
      ...
      <c:set var="recurringChargesCount" value="${fn:length(product.price.recurringChargeEntries)}"/>
      <c:set var="usageChargesCount" value="${fn:length(product.price.usageCharges)}"/>

      ...
      <div class="col-sm-6">
         <div>
            ...
            <div>
               ...
               &nbsp; ${orderEntry.product.minimumTerm}&nbsp<spring:theme code="text.product.usage.months"/>
            </div>
            <div>
               <strong>
               ...
               &nbsp; ${orderEntry.product.subscriptionValidTerm}&nbsp<spring:theme code="text.product.usage.months"/>
            </div>
            <div>
               <strong>
            ...
            <div>
               ...
               <table class="table table-striped table-bordered ">
                  <thead>
                     <tr>
                        <th><spring:theme code="text.product.rateplanelement"/></th>
                        <th><spring:theme code="text.product.price"/></th>
                        <th><spring:theme code="text.product.discount"/></th>
                        <th><spring:theme code="text.product.total"/></th>
                     </tr>
                  </thead>
                  <tbody>
                  ...
                  <c:when test="${volumeUsageChargeEntriesCount ne 0}">
                     ...
                     <table class="table table-striped table-bordered">
                        <thead>
                           <tr>
                              <th><spring:theme code="text.product.rateplanelement"/></th>
                              <th><spring:theme code="text.product.upto"/></th>
                              <th><spring:theme code="text.product.fixedprice"/></th>
                              <th><spring:theme code="text.product.discount"/></th>
                              <th><spring:theme code="text.product.total"/></th>
                              <th><spring:theme code="text.product.priceperblock"/></th>
                              <th><spring:theme code="text.product.discount"/></th>
                              <th><spring:theme code="text.product.total"/></th>
                           </tr>
                        </thead>
                                 ...
                                 <c:forEach items="${usageCharge.usageChargeEntries}" var="usageChargeEntry" varStatus="usageChargeEntryStatus">
                                    ...
                                    <tr>
                                       ...
                                       <c:if test="${usageChargeEntry['class'].simpleName eq 'OverageUsageChargeEntryData'}">
                                          <td>${prevTierValue + 1} - <spring:theme code="text.product.unlimited"/></td>
                                          <%--Fixed Price--%>
                                          <td>
                                             <format:fromPrice priceData="${usageChargeEntry.fixedPrice}"/>
                                          </td>
                  ...
                  <c:when test="${blockUsageChargeEntriesCount ne 0}">
                     ...
                     <table class="table table-striped table-bordered">
                        <thead>
                           <tr>
                              <th><spring:theme code="text.product.rateplanelement"/></th>
                              <th><spring:theme code="text.product.includedquantity"/></th>
                              <th><spring:theme code="text.product.charges"/></th>
                              <th><spring:theme code="text.product.discount"/></th>
                              <th><spring:theme code="text.product.total"/></th>
                           </tr>
                        </thead>
                  ...
                  <c:when test="${tierUsageChargeEntriesCount ne 0}">
                     ...
                     <table class="table table-striped table-bordered">
                        <thead>
                           <tr>
                              <th><spring:theme code="text.product.rateplanelement"/></th>
                              <th><spring:theme code="text.product.minimumblocks"/></th>
                              <th><spring:theme code="text.product.upto"/></th>
                              <th><spring:theme code="text.product.priceperblock"/></th>
                              <th><spring:theme code="text.product.discount"/></th>
                              <th><spring:theme code="text.product.total"/></th>
                  ...
                  <c:when test="${percentageUsageChargeEntriesCount ne 0}">
                     ...
                     <table class="table table-striped table-bordered">
                        <thead>
                           <tr>
                              <th><spring:theme code="text.product.rateplanelement"/></th>
                              <th><spring:theme code="text.product.ratio"/></th>
                              <th><spring:theme code="text.product.charges"/></th>
                              <th><spring:theme code="text.product.discount"/></th>
                              <th><spring:theme code="text.product.total"/></th>
                           </tr>

...
<ul class="item__list item__list__cart">
    <li class="hidden-xs hidden-sm">
        <ul class="item__list--header">
			...
			<li class="item__price"><spring:theme code="basket.page.discountPercent"/></li>
    ...
    <c:forEach items="${quoteData.entries}" var="orderEntry" varStatus="loop"> 
        ...
        <li class="item__list--item">
            ...
            <%-- discount --%>
            <c:if test="${not empty orderEntry.discountPercent}">
                <div class="item__price">
                    <span class="visible-xs visible-sm"><spring:theme code="basket.page.itemDiscount"/>:</span>
